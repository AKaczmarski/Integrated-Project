 ...
 * @author Dziugas
 */
public class Ch_Dashboard extends javax.swing.JFrame {

    /**
     * Creates new form Ch_Dashboard
     * @param chefID
     */
    private final String schID;
    public Ch_Dashboard(String chefID) {
        initComponents();
        //Did this
        schID = chefID;
  ...
  /*  public static void main(String args[]) {
        ...
        /* try {                                                                                                           THIS ONE HAD A PROBLEM SO I COMMENTED IT IDK WHAT DOES IT DO BUT SEEMS TO BE WORKING
            ...
            java.util.logging.Logger.getLogger(Ch_Dashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               // new Ch_Dashboard(chefID).setVisible(true); Commented it because it wouldn't compile with it, we'll test later
            }
        });
    }
